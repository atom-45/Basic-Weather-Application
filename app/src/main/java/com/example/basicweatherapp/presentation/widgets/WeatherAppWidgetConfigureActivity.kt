package com.example.basicweatherapp.presentation.widgets
...
class WeatherAppWidgetConfigureActivity : Activity() {
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        mAppWidgetText.setText(loadTitlePref(this@WeatherAppWidgetConfigureActivity, mAppWidgetId))
    }

    companion object {
        private const val PREFS_NAME = "com.example.basicweatherapp.presentation.widgets.WeatherAppWidget"
